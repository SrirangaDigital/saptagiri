...
function getMonth($month)
{
	...
	$month = preg_replace("/02/", "फ़रवरी", $month);
	$month = preg_replace("/03/", "मार्च", $month);
	$month = preg_replace("/04/", "अप्रैल", $month);
	$month = preg_replace("/05/", "मई", $month);
	$month = preg_replace("/06/", "जून", $month);
	$month = preg_replace("/07/", "जुलाई", $month);
	$month = preg_replace("/08/", "अगस्त", $month);
	$month = preg_replace("/09/", "सितम्बर", $month);
	$month = preg_replace("/10/", "अक्टूबर", $month);
	$month = preg_replace("/11/", "नवम्बर", $month);
	$month = preg_replace("/12/", "दिसम्बर", $month);
